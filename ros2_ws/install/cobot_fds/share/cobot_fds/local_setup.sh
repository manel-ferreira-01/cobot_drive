...
: ${AMENT_CURRENT_PREFIX:="/workspace/ros2_ws/install/cobot_fds"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cobot_fds/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cobot_fds/environment/path.sh"
