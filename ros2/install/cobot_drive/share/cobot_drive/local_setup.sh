...
: ${AMENT_CURRENT_PREFIX:="/workspace/ros2/install/cobot_drive"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cobot_drive/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cobot_drive/environment/path.sh"
